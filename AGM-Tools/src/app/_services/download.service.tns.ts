...
export class DownloadService {
    constructor(private zone: NgZone, private alertService: AlertService, private fts: FastTranslateService) { }
    public download(url: string, destination:
        ...
        return new Promise((resolve, reject) => {
            ...
            const path = android.os.Environment.getExternalStoragePublicDirectory(d).getAbsolutePath();
