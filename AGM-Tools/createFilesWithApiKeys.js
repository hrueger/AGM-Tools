...
const files = {
    ...
    "src/environments/environment.prod.ts": 'export const environment = {apiUrl: "", defaultLanguage: "", documentServerUrl: "", appUrl: "", firebase: {apiKey: "",appId: "",authDomain: "",databaseURL: "",messagingSenderId: "",projectId: "",storageBucket: ""},production: true};',
