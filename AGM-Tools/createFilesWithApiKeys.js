...
const files = {
    "src/environments/environment.ts": 'export const environment = {apiUrl: "", appUrl: "", firebase: {apiKey: "",appId: "",authDomain: "",databaseURL: "",messagingSenderId: "",projectId: "",storageBucket: ""},production: false};',
    "src/environments/environment.prod.ts": 'export const environment = {apiUrl: "", appUrl: "", firebase: {apiKey: "",appId: "",authDomain: "",databaseURL: "",messagingSenderId: "",projectId: "",storageBucket: ""},production: true};',
