...
const projectItemGuidStart = "f069b07a6ef440cf8254";
const normalItemGuidStart = "f069b07b6ef440cf8254";
const parentGuid = "00000000000000000000000000000000";
const guidRestLength = 12;
const itemTypes: any = {
    file: 0,
    folder: 1,
};
...
class VirtualFileSystemController {
    ...
    public static content = async (req: Request, res: Response) => {
        // res.sendFile(await getStoragePath(
        // await getRepository(File).findOne(getIdFromGuid(req.params.id))));
        res.send("Servus");
        res.send({});
    }
}
